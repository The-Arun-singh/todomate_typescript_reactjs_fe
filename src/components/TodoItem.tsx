...
export const TodoItem = (props: { todo: Todo }) => {
  ...
  const handleUpdate = (todoId: string) => {
    if (editingTodoText.trim() !== '') {
      ...
      toast.error('Todo feild cannot be Empty!')
    }
  }
  ...
  return (
      ...
      {editingTodoId === todo.id ? (
        ...
        >
          ...
          />
          <button
            className='px-5 py-2 text-sm font-normal text-orange-500 bg-orange--900 border-2 border-orange-900 active:scale-95 rounded-xl'
